...
def load_and_update_config(config_path: str, **kwargs) -> Dict[str, Any]:
    """
    Load configuration from file and update with provided kwargs.
    ...
    **kwargs : dict
    ...
    for key, value in kwargs.items():
        ...
        elif key in config["data_processing"]:
            config["data_processing"][key] = value
        elif key in config["testing"]:
